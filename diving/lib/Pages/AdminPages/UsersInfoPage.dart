                ...
                children: [
                                        ...
                                        child: ListTile(
                                            title: Row(
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                    child: Text(plural(LocaleKeys.id_, user.id!)),
                                                  ),
                                                ),
                                                Container(
                                                  child: Text(plural(LocaleKeys.login_, 0,namedArgs: {"login": user.login!})),
                                                ),
                                                Expanded(
                                                  child: Container(
                                                    child: Text(plural(LocaleKeys.role_id_, user.roleId!)),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(LocaleKeys.create_new_user.tr(),style: TextStyle(color: Colors.white, fontSize: 15),),
                    ),
                  ),
                  Container(
                    height: 40,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async{
                        showDialog(context: context,
                            builder: (context) => SimpleDialog(
                              title: Text(LocaleKeys.do_you_really_want_to_delete_this_user.tr()),
                      ...
                      child: Text(LocaleKeys.delete_user_by_id.tr(),style: TextStyle(color: Colors.white, fontSize: 15),),
                    ),
                  )
                ],
              ),
